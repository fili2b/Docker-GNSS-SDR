# Dockerfile modified by Therese FILI, based on the Carles Fernandez-Prades' one
...
WORKDIR /home
COPY startGNSS.sh /home/startGNSS.sh
RUN chmod 777 /home/startGNSS.sh
RUN /usr/bin/volk_profile -v 8111
RUN /usr/local/bin/volk_gnsssdr_profile
CMD ["/bin/sh", "-c", "/home/startGNSS.sh"]